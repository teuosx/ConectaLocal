...
<body>
  ...
  <header class="header">
    ...
    <div class="header-icones">
      <a href="telaincial_user.php"><img src="casa.svg" alt="Home" class="icon"></a>
    ...
    <div class="perfil-grupo" onclick="toggleDropdown()">
      ...
      <div class="rodape-menu" id="rodape-menu">
        <a href="conf_user.php"><img src="conf.svg" alt="Opções"> Opções</a>
        <a href="cadastro_mercado.html"><img src="cmercado1.svg" alt="Cadastrar Mercado"> Cadastrar Mercado</a>
...
<button class="carousel-button right" onclick="moveCarousel('carousel2', 1)">❯</button>
  ...
  <nav class="barra_pesquisa" id="barra_pesquisa">
    ...
    <a href="mercados_ativos.php"><img src="mercado.svg" alt="Mercado" class="icon"></a>
    <a href="#"><img src="mercado.svg" alt="Cadastrar Mercado" class="icon"></a>
